...
def main():
    ...
    print('TrainSet location accuracy is ', accuracy1 * 60 / 100, 'm')    # Lab 2.7825494919432545 m    meeting 2.5322672209710784 m
    print('TestSet location accuracy is ',accuracy2 * 60 / 100, 'm')      # Lab 3.470633752181334 m     meeting 2.393443482419429 m
    ...
    # print(accuracyPre(predictions, testlabel) * 60 / 100, 'm')      # Lab 4.623876588022427 m   Meeting 2.7090642691747706 m
    ...
    # print('training time is ', round(Training_time, 6), 'seconds')  # Lab  0.195438 s             Meeting   0.149349 s
    # print(accuracyPre(prediction, testlabel) * 60 / 100, 'm')       # Lab  4.042976791760425 m    Meeting   2.6208203986177607 m
    # saveTestErrorMat(prediction, testlabel, 'Hours-Meeting-Error')
    ...
    # print('training time is ', round(Training_time, 6), 'seconds')  # Lab  0.171579 s             Meeting   0.01193 s
    # print(accuracyPre(prediction, testlabel) * 60 / 100, 'm')       # Lab  3.861484476650628 m    Meeting   3.0663604787899965 m
    # saveTestErrorMat(prediction, testlabel, 'RADAR-Meeting-Error')
    ...
    # time_start = time.time()
    # svmRegre = make_pipeline(StandardScaler(), SVC(kernel='rbf', C=12.32246781, gamma='auto'))
    ...
    # Training_time = time.time() - time_start
    # print('training time is ', round(Training_time, 6), 'seconds')  # Meeting  0.481424 s
    # print(accuracyPre(prediction, testlabel) * 60 / 100, 'm')       # Meeting  3.4693019977206507 m
    # saveTestErrorMat(prediction, testlabel, 'TMC19-Meeting-Error')
    ...
    # prediction = np.array([Y[x] for x in predictIndex])
    # Training_time = time.time() - time_start
    # print('training time is ', round(Training_time, 6), 'seconds')  # Meeting  3.68081 s
    # print(accuracyPre(prediction, testlabel) * 60 / 100, 'm')       # Meeting  2.8655647937089093 m
    # saveTestErrorMat(prediction, testlabel, 'IeeeBayes19-Meeting-Error')
